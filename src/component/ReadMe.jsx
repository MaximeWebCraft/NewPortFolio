  ...
  return (
    <div className=" border-4 overflow-hidden  border-black bg-white h-4/6 absolute left-0 right-0 mx-auto w-4/5 max-w-5xl top-40 ">
      ...
      <motion.div
        ...
        className=" px-6 pt-2 pb-12 h-full overflow-y-scroll "
      >
        ...
        <p className="mt-3">
          💼 Actuellement à la recherche d'une alternance : Je suis ouvert à des
          opportunités passionnantes au sein d'entreprises innovantes et axées
          sur le développement d'applications web et mobile.
        </p>
        <p className="mt-3">
          Si vous connaissez des entreprises ou des professionnels qui
          recherchent un stagiaire dévoué pour rejoindre leur équipe, je serais
          ravi de discuter des possibilités.
        </p>
        <p className="mt-3">
          📚 Mon bagage : diplôme de développeur d'application web et web mobile
        </p>
        <p className="mt-3">
