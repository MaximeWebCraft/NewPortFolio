...
const MyProject = ({ setIsMyProjectVisible }) => {
  return (
    <div className=" border-4 overflow-hidden border-black bg-white h-4/6 absolute left-0 right-0 mx-auto w-4/5 max-w-5xl top-40">
      ...
      <div className="px-6 pt-2 pb-12 h-full   overflow-y-scroll">
        <div className="">
          <a
            className="cursor "
          ...
          >
            <div className="flex justify-center flex-col ">
              <h1 className="text-center chicago underline  pt-3">BackRoads</h1>
        ...
        <div className="">
          ...
          >
            <div className="flex justify-center flex-col ">
              ...
              <p className="mt-3">
                Mon projet de fin d'études est une application web de gestion de
                collections qui adhère rigoureusement aux normes et bonnes
                pratiques du développement web. L'application offre un ensemble
                complet de fonctionnalités C.R.U.D. (Création, Lecture, Mise à
                jour et Suppression) pour une gestion efficace des collections.
              </p>
            </div>
          </a>
        </div>{' '}
